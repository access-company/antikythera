...
defmodule Antikythera.VersionStr do
  ...
  Mostly generated by using `Antikythera.MixCommon.version_with_last_commit_info/1` defined in `mix_common.exs` file.
  It forces incrementing OTP application versions of antikythera instances or gears according to current time and git commit hash.
  Useful if you are going to continuously deploy them on every commit to target branches.
