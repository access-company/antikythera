...
defmodule AntikytheraCore.ReductionLogBuilder do
  @max_proc_to_log 20
...
defmodule AntikytheraCore.MessageLogBuilder do
  @max_proc_to_log     5
  @max_msg_to_log      10
...
defmodule AntikytheraCore.PeriodicLogWriter do
  ...
  @impl true
  def init([file_name, build_mod | rest]) do
    write_to_terminal? = Keyword.get(rest, :write_to_terminal, false)
